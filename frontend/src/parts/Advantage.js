    ...
    <div className="bg-gray-50 py-20 mb-24 sm:mb-18 xl:mb-16">
      <div className="container mx-auto">
        <Fade bottom triggerOnce>
          ...
          Privy Solution is your trusted partner in high-level case recovery, specializing
          in retrieving
          critical details, lost assets, and essential documents. Our expert team is
          dedicated to delivering justice and resolution for even the most complex legal challenges.
          With a professional, client-focused approach, we provide unparalleled support to
          law firms and individuals, ensuring reliable and effective solutions.
          </p>
        </Fade>
