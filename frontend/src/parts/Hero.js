...
import home from "../assets/images/hero/home.jpeg";
  ...
  return (
    <section className="hero">
      <div className="w-full lg:w-1/2 xl:pl-12 sm:pr-2 mt-8">
        ...
        Justice,Expertise <br />
        Commitment.
        </h1>

        <p className="font-light text-xl text-gray-400 leading-relaxed mb-16">
        Pass your debt collection tension and efforts to us by availing of our
         full-proof debt collection company that includes
          3rd party debt collection service as well as purchase services tailored to your demand.
        </p>
      ...
      <div className="flex pt-5 md:w-fit w-full justify-center items-center order-first md:order-first lg:order-last lg:w-1/2">
        <Fade direction="up" triggerOnce>
          <img className="" src={home} alt="Build Website" />
        </Fade>
      </div>
    </section>
  );
